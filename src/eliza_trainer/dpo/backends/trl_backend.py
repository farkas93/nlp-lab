...
from ..run_config import DPORunConfig


def run_trl_dpo_training(
    *,
    run_config: DPORunConfig,
    tokenizer,
    train_dataset,
    eval_dataset,
) -> None:
    ...
    if run_config.model.load_in_4bit:
        ...
        logging.info("Attached LoRA adapters for 4-bit DPO training")
    ...
    training_args = DPOConfig(
        ...
        beta=run_config.dpo.beta,
        max_prompt_length=run_config.dpo.max_prompt_length,
        max_length=run_config.dpo.max_length,
    )
    ...
    model_ops.save_model_and_maybe_push(
        ...
        repo_name=run_config.hub.adapter_repo_name,
        full_model=run_config.hub.publish_full_model,
    ...
    mlflow.log_param("trainer_type", "dpo")
