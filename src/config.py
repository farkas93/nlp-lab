...
CHECKPOINT_DIR = "./outputs/gemma_dpo_rag_v1/gemma-1.1-2b-it-rag-sft/timdettmers_openassistant-guanaco/checkpoint-2462"
...
SFT_DATASETS = {
    "timdettmers/openassistant-guanaco" : { "from_ckp" : True, "splits": ["train", "test"], "subsets": ['default'], "formatter": None},
    "rajpurkar/squad_v2": {"from_ckp" : False,  "splits": ["train", "validation"], "subsets": ['squad_v2'], "formatter": squad_v2.format_for_sft},    
    "Open-Orca/SlimOrca": {"from_ckp" : False,  "splits": ["train"], "subsets": ['default'], "formatter": slim_orca.format_for_sft},    
    "facebook/belebele": {"from_ckp" : False,  "splits": ["acm_Arab", "ita_Latn", "fra_Latn", "hun_Latn",  "deu_Latn", "rus_Cyrl", "spa_Latn", "eng_Latn"], "subsets": ['default'], "formatter": blebele.format_for_sft},
    "allenai/ai2_arc": {"from_ckp" : False,  "splits": ["train", "validation", "test"], "subsets": ['ARC-Challenge', 'ARC-Easy'], "formatter": ai2_arc.format_for_sft},
}
SFT_DATASETS_LIST=["timdettmers/openassistant-guanaco",                   
            ...
            # After that, stop the training, increase the context window and train it again 
