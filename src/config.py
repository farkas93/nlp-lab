...
SFT_DATASETS = {
    "timdettmers/openassistant-guanaco" : { "max_seq_len": 1024, "splits": ["train", "test"], "subsets": ['default'], "formatter": None},
    "rajpurkar/squad_v2": { "max_seq_len": 1024, "splits": ["train", "validation"], "subsets": ['squad_v2'], "formatter": squad_v2.format_for_sft},    
    "Open-Orca/SlimOrca": { "max_seq_len": 1024, "splits": ["train"], "subsets": ['default'], "formatter": slim_orca.format_for_sft},    
    "facebook/belebele": { "max_seq_len": 32000, "splits": ["acm_Arab", "ita_Latn", "fra_Latn", "hun_Latn",  "deu_Latn", "rus_Cyrl", "spa_Latn", "eng_Latn"], "subsets": ['default'], "formatter": blebele.format_for_sft},
    "allenai/ai2_arc": { "max_seq_len": 32000, "splits": ["train", "validation", "test"], "subsets": ['ARC-Challenge', 'ARC-Easy'], "formatter": ai2_arc.format_for_sft},
}
SFT_DATASETS_LIST=[
            ...
            #TODO: After that, stop the training, increase the context window and train it again 
